...
START_TEST(test_calc_3) {
  char givenStr[] = "sqrt(4.12)+asin(0)";
...
START_TEST(test_calc_4) {
  char givenStr[] = "sin(pi/2)*2.231^3-acos(0.123)";
...
START_TEST(test_calc_6) {
  char givenStr[] = "cos(pi*3) + ln(0.0541)";
...
START_TEST(test_calc_7) {
  char givenStr[] = "atan(0.5422 / 23.12) + tan(0.256) + log(2.21)";
...
START_TEST(test_calc_10) {
  char givenStr[] = "12 + (cos(23.12 + sin(12.12 - cos(2.21 / 12))))";
...
START_TEST(test_calc_11) {
  char givenStr[] = "tan(pi/2)";
  double resultPN = result_PN(givenStr);
  int result = isnan(resultPN);
